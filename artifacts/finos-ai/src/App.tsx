  ...
  return <div className="mx-auto max-w-[1480px]">
    ...
    <div className="mb-5 grid gap-5 xl:grid-cols-[1.5fr_.8fr]">
      <div className="panel relative overflow-hidden p-5 md:p-6">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-5 text-[10px] text-slate-500"><span className="flex items-center gap-2"><i className="h-2 w-2 rounded-full bg-violet-400"/>Payment volume</span><span className="flex items-center gap-2"><i className="h-2 w-2 rounded-full bg-emerald-400"/>Captured: {metrics.captured}</span><span className="ml-auto mono text-slate-300">{range} • {formatDashboardMoney(metrics.totalVolume)}</span></div>
      </div>
