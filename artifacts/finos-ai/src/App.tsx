...
function getNavGroups(showMerchant: boolean) {
  return [
    ...
    { label:'Platform', items:[['/platform-admin', 'Platform admin', ShieldCheck], ['/integrations', 'Integrations', Zap], ['/email', 'Email center', Send]] },
  ];
}
